...
export const RedCircleIcon = ({
  className,
  ...rest
}) => <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true" // Decorative icon
{...rest}>
...
export const SunIcon = ({
  className,
  ...rest
}) => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className={className} {...rest}>
