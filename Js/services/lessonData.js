...
const getCharOrThrow = (charSet, charSymbol, lessonContext) => {
...
const hiraganaVowels = [{
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/あ.gif`
}, {
  char: 'い',
  romaji: 'i',
  exampleWord: 'いぬ',
  ...
  exampleMeaning: 'dog',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/い.gif`
}, {
  char: 'う',
  romaji: 'u',
  exampleWord: 'うみ',
  ...
  exampleMeaning: 'sea',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/う.gif`
}, {
  char: 'え',
  romaji: 'e',
  exampleWord: 'えき',
  ...
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/え.gif`
}, {
  char: 'お',
  romaji: 'o',
  exampleWord: 'おと',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/お.gif`
}];
const hiraganaKLine = [{
  char: 'か',
  romaji: 'ka',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/か.gif`,
  exampleWord: 'かさ',
  exampleRomaji: 'kasa',
  ...
  romaji: 'ki',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/き.gif`,
  exampleWord: 'きく',
  exampleRomaji: 'kiku',
  ...
  romaji: 'ku',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/く.gif`,
  exampleWord: 'くつ',
  exampleRomaji: 'kutsu',
  ...
  romaji: 'ke',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/け.gif`,
  exampleWord: 'けむし',
  exampleRomaji: 'kemushi',
  exampleMeaning: 'caterpillar'
}, {
  char: 'こ',
  romaji: 'ko',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/こ.gif`,
  exampleWord: 'こえ',
  exampleRomaji: 'koe',
...
const hiraganaSLine = [{
  ...
  romaji: 'sa',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/さ.gif`
}, {
  char: 'し',
  romaji: 'shi',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/し.gif`
}, {
  char: 'す',
  romaji: 'su',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/す.gif`
}, {
  char: 'せ',
  romaji: 'se',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/せ.gif`
}, {
  char: 'そ',
  romaji: 'so',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/そ.gif`
}];
const hiraganaTLine = [{
  char: 'た',
  romaji: 'ta',
  exampleWord: 'たな',
  exampleRomaji: 'tana',
  exampleMeaning: 'shelf',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/た.gif`
}, {
  char: 'ち',
  romaji: 'chi',
  exampleWord: 'ちか',
  ...
  exampleMeaning: 'near',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ち.gif`
}, {
  char: 'つ',
  romaji: 'tsu',
  exampleWord: 'つくえ',
  exampleRomaji: 'tsukue',
  exampleMeaning: 'desk',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/つ.gif`
}, {
  char: 'て',
  romaji: 'te',
  exampleWord: 'て',
  ...
  exampleMeaning: 'hand',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/て.gif`
}, {
  char: 'と',
  romaji: 'to',
  exampleWord: 'とけい',
  ...
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/と.gif`
}];
const hiraganaNLine = [{
  char: 'な',
  romaji: 'na',
  ...
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/な.gif`
}, {
  char: 'に',
  romaji: 'ni',
  exampleWord: 'にく',
  ...
  exampleMeaning: 'meat',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/に.gif`
}, {
  char: 'ぬ',
  romaji: 'nu',
  exampleWord: 'いぬ',
  ...
  exampleMeaning: 'dog',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぬ.gif`
}, {
  char: 'ね',
  romaji: 'ne',
  exampleWord: 'ねこ',
  ...
  exampleMeaning: 'cat',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ね.gif`
}, {
  char: 'の',
  romaji: 'no',
  exampleWord: 'のり',
  ...
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/の.gif`
}];
const hiraganaHLine = [{
  char: 'は',
  romaji: 'ha',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/は.gif`
}, {
  char: 'ひ',
  romaji: 'hi',
  exampleWord: 'ひと',
  ...
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ひ.gif`
}, {
  char: 'ふ',
  romaji: 'fu',
  exampleWord: 'ふね',
  ...
  exampleMeaning: 'boat',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ふ.gif`
}, {
  char: 'へ',
  romaji: 'he',
  exampleWord: 'へや',
  ...
  exampleMeaning: 'room',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/へ.gif`
}, {
  char: 'ほ',
  romaji: 'ho',
  exampleWord: 'ほし',
  ...
  exampleMeaning: 'star',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ほ.gif`
}];
const hiraganaMLine = [{
  char: 'ま',
  romaji: 'ma',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ま.gif`
}, {
  char: 'み',
  romaji: 'mi',
  exampleWord: 'みみ',
  ...
  exampleMeaning: 'ear',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/み.gif`
}, {
  char: 'む',
  romaji: 'mu',
  exampleWord: 'むし',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/む.gif`
}, {
  char: 'め',
  romaji: 'me',
  exampleWord: 'め',
  ...
  exampleMeaning: 'eye',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/め.gif`
}, {
  char: 'も',
  romaji: 'mo',
  exampleWord: 'もも',
  exampleRomaji: 'momo',
  exampleMeaning: 'peach',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/も.gif`
}];
const hiraganaYLine = [{
  char: 'や',
  romaji: 'ya',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/や.gif`
}, {
  char: 'ゆ',
  romaji: 'yu',
  exampleWord: 'ゆき',
  ...
  exampleMeaning: 'snow',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ゆ.gif`
}, {
  char: 'よ',
  romaji: 'yo',
  exampleWord: 'よる',
  ...
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/よ.gif`
}];
const hiraganaRLine = [{
  char: 'ら',
  romaji: 'ra',
  ...
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ら.gif`
}, {
  char: 'り',
  romaji: 'ri',
  exampleWord: 'とり',
  ...
  exampleMeaning: 'bird',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/り.gif`
}, {
  char: 'る',
  romaji: 'ru',
  exampleWord: 'はる',
  ...
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/る.gif`
}, {
  char: 'れ',
  romaji: 're',
  exampleWord: 'これ',
  ...
  exampleMeaning: 'this',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/れ.gif`
}, {
  char: 'ろ',
  romaji: 'ro',
  exampleWord: 'しろ',
  ...
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ろ.gif`
}];
const hiraganaWLineN = [{
  char: 'わ',
  romaji: 'wa',
  exampleWord: 'わたし',
  ...
  exampleMeaning: 'I/me',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/わ.gif`
}, {
  char: 'を',
  romaji: 'wo (o)',
  exampleWord: 'ほんをよむ',
  exampleRomaji: 'hon o yomu',
  exampleMeaning: 'read a book (object marker)',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/を.gif`
}, {
  char: 'ん',
  romaji: 'n',
  exampleWord: 'パン',
  ...
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ん.gif`
}];
const hiraganaDakutenGZDB = [{
  char: 'が',
  romaji: 'ga',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/が.gif`
}, {
  char: 'ぎ',
  romaji: 'gi',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぎ.gif`
}, {
  char: 'ぐ',
  romaji: 'gu',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぐ.gif`
}, {
  char: 'げ',
  romaji: 'ge',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/げ.gif`
}, {
  char: 'ご',
  romaji: 'go',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ご.gif`
}, {
  char: 'ざ',
  romaji: 'za',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ざ.gif`
}, {
  char: 'じ',
  romaji: 'ji',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/じ.gif`
}, {
  char: 'ず',
  romaji: 'zu',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ず.gif`
}, {
  char: 'ぜ',
  romaji: 'ze',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぜ.gif`
}, {
  char: 'ぞ',
  romaji: 'zo',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぞ.gif`
}, {
  char: 'だ',
  romaji: 'da',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/だ.gif`
}, {
  char: 'ぢ',
  romaji: 'ji (di)',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぢ.gif`
},
// rare, filename is di.gif
{
  char: 'づ',
  romaji: 'zu (du)',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/づ.gif`
},
// rare, filename is du.gif
{
  char: 'で',
  romaji: 'de',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/で.gif`
}, {
  char: 'ど',
  romaji: 'do',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ど.gif`
}, {
  char: 'ば',
  romaji: 'ba',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ば.gif`
}, {
  char: 'び',
  romaji: 'bi',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/び.gif`
}, {
  char: 'ぶ',
  romaji: 'bu',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぶ.gif`
}, {
  char: 'べ',
  romaji: 'be',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/べ.gif`
}, {
  char: 'ぼ',
  romaji: 'bo',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぼ.gif`
}];
const hiraganaHandakutenP = [{
  char: 'ぱ',
  romaji: 'pa',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぱ.gif`
}, {
  char: 'ぴ',
  romaji: 'pi',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぴ.gif`
}, {
  char: 'ぷ',
  romaji: 'pu',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぷ.gif`
}, {
  char: 'ぺ',
  romaji: 'pe',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/gif/150x150/ぺ.gif`
}, {
  char: 'ぽ',
  romaji: 'po',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}hiragana/static/150x150/ぽ.png`
}];
const hiraganaYoon = [{
  char: 'きゃ',
  romaji: 'kya'
...
const katakanaVowels = [{
  ...
  romaji: 'a',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ア.gif`
}, {
  char: 'イ',
  romaji: 'i',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/イ.gif`
}, {
  char: 'ウ',
  romaji: 'u',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ウ.gif`
}, {
  char: 'エ',
  romaji: 'e',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/エ.gif`
}, {
  char: 'オ',
  romaji: 'o',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/オ.gif`
}];
const katakanaKLine = [{
  char: 'カ',
  romaji: 'ka',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/カ.gif`
}, {
  char: 'キ',
  romaji: 'ki',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/キ.gif`
}, {
  char: 'ク',
  romaji: 'ku',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ク.gif`
}, {
  char: 'ケ',
  romaji: 'ke',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ケ.gif`
}, {
  char: 'コ',
  romaji: 'ko',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/コ.gif`
}];
const katakanaSLine = [{
  char: 'サ',
  romaji: 'sa',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/サ.gif`
}, {
  char: 'シ',
  romaji: 'shi',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/シ.gif`
}, {
  char: 'ス',
  romaji: 'su',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ス.gif`
}, {
  char: 'セ',
  romaji: 'se',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/セ.gif`
}, {
  char: 'ソ',
  romaji: 'so',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ソ.gif`
}];
const katakanaTLine = [{
  char: 'タ',
  romaji: 'ta',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/タ.gif`
}, {
  char: 'チ',
  romaji: 'chi',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/チ.gif`
}, {
  char: 'ツ',
  romaji: 'tsu',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ツ.gif`
}, {
  char: 'テ',
  romaji: 'te',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/テ.gif`
}, {
  char: 'ト',
  romaji: 'to',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ト.gif`
}];
const katakanaNLine = [{
  char: 'ナ',
  romaji: 'na',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ナ.gif`
}, {
  char: 'ニ',
  romaji: 'ni',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ニ.gif`
}, {
  char: 'ヌ',
  romaji: 'nu',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ヌ.gif`
}, {
  char: 'ネ',
  romaji: 'ne',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ネ.gif`
}, {
  char: 'ノ',
  romaji: 'no',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ノ.gif`
}];
const katakanaHLine = [{
  char: 'ハ',
  romaji: 'ha',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ハ.gif`
}, {
  char: 'ヒ',
  romaji: 'hi',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ヒ.gif`
}, {
  char: 'フ',
  romaji: 'fu',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/フ.gif`
}, {
  char: 'ヘ',
  romaji: 'he',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ヘ.gif`
}, {
  char: 'ホ',
  romaji: 'ho',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ホ.gif`
}];
const katakanaMLine = [{
  char: 'マ',
  romaji: 'ma',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/マ.gif`
}, {
  char: 'ミ',
  romaji: 'mi',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ミ.gif`
}, {
  char: 'ム',
  romaji: 'mu',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ム.gif`
}, {
  char: 'メ',
  romaji: 'me',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/メ.gif`
}, {
  char: 'モ',
  romaji: 'mo',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/モ.gif`
}];
const katakanaYLine = [{
  char: 'ヤ',
  romaji: 'ya',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ヤ.gif`
}, {
  char: 'ユ',
  romaji: 'yu',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ユ.gif`
}, {
  char: 'ヨ',
  romaji: 'yo',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ヨ.gif`
}];
const katakanaRLine = [{
  char: 'ラ',
  romaji: 'ra',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ラ.gif`
}, {
  char: 'リ',
  romaji: 'ri',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/リ.gif`
}, {
  char: 'ル',
  romaji: 'ru',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ル.gif`
}, {
  char: 'レ',
  romaji: 're',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/レ.gif`
}, {
  char: 'ロ',
  romaji: 'ro',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ロ.gif`
}];
const katakanaWLineN = [{
  char: 'ワ',
  romaji: 'wa',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ワ.gif`
}, {
  char: 'ヰ',
  romaji: 'wi',
  strokeCount: 4,
  strokeOrderDiagramUrl: `https://upload.wikimedia.org/wikipedia/commons/d/d6/Katakana_%E3%83%B0_stroke_order_animation.gif`
},
// Obsolete
{
  char: 'ヱ',
  romaji: 'we',
  strokeCount: 3,
  strokeOrderDiagramUrl: `https://upload.wikimedia.org/wikipedia/commons/1/14/Katakana_%E3%83%B1_stroke_order_animation.gif`
},
// Obsolete
{
  char: 'ヲ',
  romaji: 'wo (o)',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}katakana/gif/150x150/ヲ.gif`
},
// Rare, mostly for stylistic use
{
  char: 'ン',
  romaji: 'n',
  strokeCount: 2,
  strokeOrderDiagramUrl: `https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Katakana_%E3%83%B3_stroke_order_animation.gif/285px-Katakana_%E3%83%B3_stroke_order_animation.gif`
}];
...
// Kanji Section
const kanjiSet1_NumbersPeopleDay = [{
  char: '一',
  romaji: 'ichi, hito(tsu)',
  exampleWord: '一つ (hitotsu)',
  exampleRomaji: 'hitotsu',
  exampleMeaning: 'one (thing)',
  strokeCount: 1,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/一.gif`
}, {
  char: '二',
  romaji: 'ni, futa(tsu)',
  exampleWord: '二つ (futatsu)',
  exampleRomaji: 'futatsu',
  exampleMeaning: 'two (things)',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/二.gif`
}, {
  char: '三',
  romaji: 'san, mit(tsu)',
  exampleWord: '三つ (mittsu)',
  exampleRomaji: 'mittsu',
  exampleMeaning: 'three (things)',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/三.gif`
}, {
  char: '人',
  romaji: 'jin, nin, hito',
  ...
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/人.gif`
}, {
  char: '日',
  romaji: 'nichi, jitsu, hi, -ka',
  exampleWord: '日曜日 (nichiyoubi)',
  exampleRomaji: 'nichiyoubi',
  exampleMeaning: 'Sunday',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/日.gif`
}];
const kanjiSet2_ElementsTime = [{
  char: '月',
  ...
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/月.gif`
}, {
  char: '火',
  romaji: 'ka, hi, -bi',
  ...
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/火.gif`
}, {
  char: '水',
  romaji: 'sui, mizu',
  exampleWord: '水曜日 (suiyoubi)',
  exampleRomaji: 'suiyoubi',
  exampleMeaning: 'Wednesday',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/水.gif`
}, {
  char: '木',
  romaji: 'moku, boku, ki, ko-',
  exampleWord: '木曜日 (mokuyoubi)',
  exampleRomaji: 'mokuyoubi',
  exampleMeaning: 'Thursday',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/木.gif`
}, {
  char: '金',
  romaji: 'kin, kon, kane',
  exampleWord: '金曜日 (kinyoubi)',
  exampleRomaji: 'kinyoubi',
  exampleMeaning: 'Friday',
  strokeCount: 8,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/金.gif`
}, {
  char: '土',
  romaji: 'do, to, tsuchi',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/土.gif`
}, {
  char: '年',
  romaji: 'nen, toshi',
  ...
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/年.gif`
}];
const kanjiSet3_SizesPosition = [{
  char: '大',
  romaji: 'dai, tai, oo(kii)',
  exampleWord: '大学 (daigaku)',
  exampleRomaji: 'daigaku',
  exampleMeaning: 'university',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/大.gif`
}, {
  char: '小',
  romaji: 'shou, chii(sai), ko-, o-',
  exampleWord: '小さい (chiisai)',
  exampleRomaji: 'chiisai',
  exampleMeaning: 'small',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/小.gif`
}, {
  char: '中',
  romaji: 'chuu, naka',
  ...
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/中.gif`
}, {
  char: '上',
  romaji: 'jou, shou, ue, uwa-, kami, a(geru), nobo(ru)',
  exampleWord: '上 (ue)',
  exampleRomaji: 'ue',
  exampleMeaning: 'up, above',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/上.gif`
}, {
  char: '下',
  romaji: 'ka, ge, shita, shimo, moto, sa(geru), o(riru), kuda(saru)',
  exampleWord: '下 (shita)',
  exampleRomaji: 'shita',
  exampleMeaning: 'down, below',
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/下.gif`
}, {
  char: '右',
  romaji: 'u, yuu, migi',
  exampleWord: '右手 (migite)',
  exampleRomaji: 'migite',
  exampleMeaning: 'right hand',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/右.gif`
}, {
  char: '左',
  romaji: 'sa, sha, hidari',
  exampleWord: '左手 (hidarite)',
  exampleRomaji: 'hidarite',
  exampleMeaning: 'left hand',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/左.gif`
}];
const kanjiSet4_DirectionsPlaces = [{
  char: '東',
  romaji: 'tou, higashi',
  exampleWord: '東京 (toukyou)',
  exampleRomaji: 'toukyou',
  exampleMeaning: 'Tokyo',
  strokeCount: 8,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/東.gif`
}, {
  char: '西',
  romaji: 'sei, sai, nishi',
  exampleWord: '西口 (nishiguchi)',
  exampleRomaji: 'nishiguchi',
  exampleMeaning: 'west exit',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/西.gif`
}, {
  char: '南',
  romaji: 'nan, na, minami',
  exampleWord: '南アメリカ (minami amerika)',
  exampleRomaji: 'minami amerika',
  exampleMeaning: 'South America',
  strokeCount: 9,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/南.gif`
}, {
  char: '北',
  romaji: 'hoku, kita',
  exampleWord: '北海道 (hokkaidou)',
  exampleRomaji: 'hokkaidou',
  exampleMeaning: 'Hokkaido',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/北.gif`
}, {
  char: '口',
  romaji: 'kou, ku, kuchi',
  ...
  strokeCount: 3,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/口.gif`
}, {
  char: '出',
  romaji: 'shutsu, sui, de(ru), da(su)',
  exampleWord: '出口 (deguchi)',
  exampleRomaji: 'deguchi',
  exampleMeaning: 'exit',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/出.gif`
}, {
  char: '入',
  romaji: 'nyuu, ju, i(ru), hai(ru)',
  exampleWord: '入る (hairu)',
  exampleRomaji: 'hairu',
  exampleMeaning: 'to enter',
  strokeCount: 2,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/入.gif`
}, {
  char: '本',
  romaji: 'hon, moto',
  exampleWord: '本 (hon)',
  ...
  exampleMeaning: 'book',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/本.gif`
}];
const kanjiSet5_VerbsActions = [{
  char: '見',
  romaji: 'ken, mi(ru)',
  exampleWord: '見る (miru)',
  exampleRomaji: 'miru',
  exampleMeaning: 'to see/watch',
  strokeCount: 7,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/見.gif`
}, {
  char: '聞',
  romaji: 'bun, mon, ki(ku)',
  exampleWord: '聞く (kiku)',
  exampleRomaji: 'kiku',
  exampleMeaning: 'to hear/listen/ask',
  strokeCount: 14,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/聞.gif`
}, {
  char: '言',
  romaji: 'gen, gon, i(u), koto',
  exampleWord: '言う (iu)',
  exampleRomaji: 'iu',
  exampleMeaning: 'to say/speak',
  strokeCount: 7,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/言.gif`
}, {
  char: '話',
  romaji: 'wa, hana(su), hanashi',
  exampleWord: '話す (hanasu)',
  exampleRomaji: 'hanasu',
  exampleMeaning: 'to talk/speak',
  strokeCount: 13,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/話.gif`
}, {
  char: '食',
  romaji: 'shoku, jiki, ta(beru), ku(u)',
  exampleWord: '食べる (taberu)',
  exampleRomaji: 'taberu',
  exampleMeaning: 'to eat',
  strokeCount: 9,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/食.gif`
}, {
  char: '飲',
  romaji: 'in, on, no(mu)',
  exampleWord: '飲む (nomu)',
  ...
  strokeCount: 12,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/飲.gif`
}];
const kanjiSet6_Adjectives = [{
  char: '新',
  romaji: 'shin, atara(shii), ara(ta), nii-',
  exampleWord: '新しい (atarashii)',
  exampleRomaji: 'atarashii',
  exampleMeaning: 'new',
  strokeCount: 13,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/新.gif`
}, {
  char: '古',
  romaji: 'ko, furu(i)',
  exampleWord: '古い (furui)',
  exampleRomaji: 'furui',
  exampleMeaning: 'old',
  strokeCount: 5,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/古.gif`
}, {
  char: '多',
  romaji: 'ta, oo(i)',
  exampleWord: '多い (ooi)',
  exampleRomaji: 'ooi',
  exampleMeaning: 'many, much',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/多.gif`
}, {
  char: '少',
  romaji: 'shou, suku(nai), suko(shi)',
  exampleWord: '少ない (sukunai)',
  exampleRomaji: 'sukunai',
  exampleMeaning: 'few, little',
  strokeCount: 4,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/少.gif`
}, {
  char: '安',
  romaji: 'an, yasu(i)',
  exampleWord: '安い (yasui)',
  exampleRomaji: 'yasui',
  exampleMeaning: 'cheap, peaceful',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/安.gif`
}, {
  char: '高',
  romaji: 'kou, taka(i)',
  exampleWord: '高い (takai)',
  exampleRomaji: 'takai',
  exampleMeaning: 'high, tall, expensive',
  strokeCount: 10,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/高.gif`
}];
const kanjiSet7_ActionsMisc = [{
  char: '行',
  romaji: 'kou, gyou, an, i(ku), yu(ku), okona(u)',
  exampleWord: '行く (iku)',
  exampleRomaji: 'iku',
  exampleMeaning: 'to go',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/行.gif`
}, {
  char: '買',
  romaji: 'bai, ka(u)',
  exampleWord: '買う (kau)',
  ...
  strokeCount: 12,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/買.gif`
}, {
  char: '旅',
  romaji: 'ryo, tabi',
  exampleWord: '旅行 (ryokou)',
  exampleRomaji: 'ryokou',
  exampleMeaning: 'travel, trip',
  strokeCount: 10,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/旅.gif`
}, {
  char: '好',
  romaji: 'kou, kono(mu), su(ku)',
  exampleWord: '好き (suki)',
  exampleRomaji: 'suki',
  exampleMeaning: 'like, fond of',
  strokeCount: 6,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/好.gif`
}];
const kanji_Toki_Time = [{
  char: '時',
  romaji: 'ji, toki',
  exampleWord: '時間 (jikan)',
  exampleMeaning: 'time, duration',
  strokeCount: 10,
  strokeOrderDiagramUrl: `${GITHUB_RAW_BASE_URL}kanji/gif/150x150/時.gif`
}];

// Helper function to generate AI Tutor system prompt
const generateAiTutorPrompt = (day, lessonTitle, lessonOverview) => {
...
export const thirtyDayPlan_Unprocessed = [
// Day 1: Introduction to Hiragana (Vowels)
{
  ...
  contentBlocks: [{
    ...
    markdownContent: 'Today, we embark on our Japanese learning journey! We will start with the foundational phonetic script, Hiragana, and learn some basic greetings. がんばって (ganbatte - good luck)!'
  }, {
    id: 'd1-hiragana-vowels',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: Vowel Sounds & Writing',
    introduction: 'These are the foundational vowel sounds in Japanese. Pay attention to their shapes, stroke order, and how they are pronounced.',
    characters: hiraganaVowels
  }, {
    id: 'd1-vocab-greetings',
...
// Day 2: Hiragana (K-line & S-line)
{
  ...
  contentBlocks: [{
    id: 'd2-intro',
    type: ContentBlockType.TEXT,
    title: 'Continuing Hiragana!',
    markdownContent: 'Let\'s expand our Hiragana knowledge with two new consonant lines: K and S. Pay close attention to the subtle differences in shapes.'
  }, {
    id: 'd2-hiragana-k',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: K-line (か, き, く, け, こ)',
    introduction: 'These characters combine "k" with the five vowel sounds.',
    characters: hiraganaKLine
  }, {
    id: 'd2-hiragana-s',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: S-line (さ, し, す, せ, そ)',
    introduction: 'These characters combine "s" with the five vowel sounds. Note that し (shi) is pronounced like "she".',
    characters: hiraganaSLine
  }, {
    id: 'd2-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'New Vocabulary with K & S',
    items: [{
      id: 'd2-vocab-0',
      japanese: 'かさ',
      romaji: 'kasa',
...
// Day 3: Basic Grammar (A は B です) & Culture
{
  ...
  contentBlocks: [{
    ...
    markdownContent: 'Today, we\'ll learn a fundamental sentence pattern. This will allow you to start forming simple descriptive sentences.'
  }, {
    id: 'd3-grammar-desu',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'The Sentence Structure: A は B です (A wa B desu)',
    ...
    exampleSentences: [{
      ...
      meaning: 'This is an umbrella.'
    }, {
      id: 'd3-gram-ex-2',
      japanese: 'すしはたかいです。',
      romaji: 'Sushi wa takai desu.',
      meaning: 'Sushi is expensive.'
    }]
  }, {
    id: 'd3-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Useful Nouns for Sentences',
    items: [{
      id: 'd3-vocab-0',
      japanese: 'わたし',
      romaji: 'watashi',
      ...
      japanese: 'あれ',
      romaji: 'are',
      meaning: 'that (thing over there, far from both)'
    }, {
      id: 'd3-vocab-5',
      japanese: 'がくせい',
      romaji: 'gakusei',
    ...
    title: 'A Quick Note on Bowing',
    note: 'Bowing (お辞儀 - ojigi) is a very important part of Japanese culture. The depth and duration of the bow depend on the situation and the relationship between the people. It\'s used for greetings, apologies, thanks, and showing respect.'
  }, {
    id: 'd3-fact',
    type: ContentBlockType.INTERESTING_FACT,
...
// Day 4: Hiragana (T-line & N-line) & Particles は, も
{
  ...
  contentBlocks: [{
    id: 'd4-intro',
    type: ContentBlockType.TEXT,
    title: 'More Hiragana & Particles!',
    markdownContent: 'Let\'s master more Hiragana and learn a new useful particle!'
  }, {
    id: 'd4-hiragana-t',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: T-line (た, ち, つ, て, と)',
    introduction: 'These are the "t" sounds. Note: ち (chi) and つ (tsu) have unique pronunciations.',
    characters: hiraganaTLine
  }, {
    id: 'd4-hiragana-n',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: N-line (な, に, ぬ, ね, の)',
    introduction: 'These are the "n" sounds.',
    characters: hiraganaNLine
  }, {
    id: 'd4-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary with T & N',
    items: [{
      id: 'd4-vocab-0',
      japanese: 'たかい',
      romaji: 'takai',
    ...
    id: 'd4-grammar-mo',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Particles: は (wa) Review & も (mo - also)',
    ...
    exampleSentences: [{
      ...
      id: 'd4-gram-ex-1',
      japanese: 'あなたもがくせいです。',
      romaji: 'Anata mo gakusei desu.',
      meaning: 'You are also a student.'
    }, {
      id: 'd4-gram-ex-2',
      japanese: 'これはねこです。それもねこです。',
      romaji: 'Kore wa neko desu. Sore mo neko desu.',
      meaning: 'This is a cat. That is also a cat.'
    }]
  }, {
    id: 'd4-fill-blank-mo',
    type: ContentBlockType.FILL_IN_THE_BLANK_EXERCISE,
...
// Day 5: Hiragana (H-line & M-line) & Asking Questions (か)
{
  ...
  contentBlocks: [{
    id: 'd5-intro',
    type: ContentBlockType.TEXT,
    title: 'Final Basic Hiragana Rows & Questions!',
    markdownContent: 'Today we will cover more Hiragana and learn a crucial skill: asking questions!'
  }, {
    id: 'd5-hiragana-h',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: H-line (は, ひ, ふ, へ, ほ)',
    introduction: 'These are the "h" sounds. Remember, は (ha) is pronounced "wa" when used as a topic particle!',
    characters: hiraganaHLine
  }, {
    id: 'd5-hiragana-m',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: M-line (ま, み, む, め, も)',
    introduction: 'These are the "m" sounds.',
    characters: hiraganaMLine
  }, {
    id: 'd5-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary with H & M',
    items: [{
      id: 'd5-vocab-0',
      japanese: 'はな',
      romaji: 'hana',
    ...
    id: 'd5-grammar-ka',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Asking Questions with か (ka)',
    ...
    exampleSentences: [{
      ...
      id: 'd5-gram-ex-2',
      japanese: 'いいえ、せんせいではありません。',
      romaji: 'Iie, sensei dewa arimasen.',
      meaning: 'No, I am not a teacher. (ではありません - dewa arimasen is the polite negative of です)'
    }]
  }
  // ADD DAY 5 FACT HERE
  ]
...
// Day 6: Hiragana (Y, R lines) & Particle の (Possession)
{
  ...
  contentBlocks: [{
    id: 'd6-intro',
    type: ContentBlockType.TEXT,
    title: 'More Hiragana & Showing Possession!',
    markdownContent: 'We are getting close to finishing basic Hiragana! Today we also learn how to say "my book" or "Tanaka\'s cat".'
  }, {
    id: 'd6-hiragana-y',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: Y-line (や, ゆ, よ)',
    introduction: 'These are the "y" sounds. There are only three in this set.',
    characters: hiraganaYLine
  }, {
    id: 'd6-hiragana-r',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: R-line (ら, り, る, れ, ろ)',
    introduction: 'These are the "r" sounds. The Japanese "r" is a bit like a soft "d" or a flicked "l", not a hard English "r".',
    characters: hiraganaRLine
  }, {
    id: 'd6-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary with Y & R',
    items: [{
      id: 'd6-vocab-0',
      japanese: 'やま',
      romaji: 'yama',
    ...
    exampleSentences: [{
      id: 'd6-gram-ex-0',
      japanese: 'これはわたしのかさです。',
      romaji: 'Kore wa watashi no kasa desu.',
      meaning: 'This is my umbrella.'
    }, {
      id: 'd6-gram-ex-1',
      japanese: 'あれはせんせいのくるまですか。',
      romaji: 'Are wa sensei no kuruma desu ka?',
      meaning: 'Is that the teacher\'s car over there?'
    }, {
      id: 'd6-gram-ex-2',
      japanese: 'たなかさんのいぬはちいさいです。',
      romaji: 'Tanaka-san no inu wa chiisai desu.',
      meaning: 'Mr. Tanaka\'s dog is small.'
    }]
  }, {
...
// Day 7: Hiragana (W-line, ん) & Review
{
  ...
  contentBlocks: [{
    id: 'd7-intro',
    type: ContentBlockType.TEXT,
    title: 'Completing Basic Hiragana!',
    markdownContent: 'Congratulations! After today, you will know all the basic Hiragana characters. We will then focus on variations and Katakana.'
  }, {
    id: 'd7-hiragana-w-n',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'Hiragana: W-line (わ, を) and ん (n)',
    ...
    items: [{
      ...
      japanese: 'ほんをよむ',
      romaji: 'hon o yomu',
      meaning: 'to read a book (を as object marker)'
    }, {
      id: 'd7-vocab-2',
      japanese: 'パン',
      romaji: 'pan',
      meaning: 'bread (from Portuguese pão)'
    }, {
      id: 'd7-vocab-3',
      japanese: 'えんぴつ',
      romaji: 'enpitsu',
    ...
    id: 'd7-review',
    type: ContentBlockType.TEXT,
    title: 'Hiragana Review Time!',
    markdownContent: 'Take some time to review all the Hiragana characters learned from Day 1 to Day 7. Use the Kana tables in previous lessons. Try writing them all out!'
  }
  // ADD DAY 7 FACT HERE
  ]
},
// Day 8: Voiced Sounds (Dakuten) & P-sounds (Handakuten)
{
  ...
  contentBlocks: [{
    id: 'd8-intro',
    type: ContentBlockType.TEXT,
    title: 'Expanding Hiragana Sounds!',
    markdownContent: 'With just two small marks, we can create many new sounds from the Hiragana we already know!'
  }, {
    id: 'd8-hiragana-dakuten',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    ...
    id: 'd8-hiragana-handakuten',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
    title: 'P-Sounds: Handakuten (゜)',
    ...
    id: 'd8-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary with Dakuten & Handakuten',
    items: [{
      id: 'd8-vocab-0',
      japanese: 'がくせい',
      romaji: 'gakusei',
      ...
      japanese: 'そば',
      romaji: 'soba',
      meaning: 'buckwheat noodles / near'
    }, {
      id: 'd8-vocab-6',
      japanese: 'ぱん',
      romaji: 'pan',
...
// Day 9: Combined Sounds (Yōon)
{
  ...
  contentBlocks: [{
    ...
    markdownContent: 'Yōon are contracted sounds that are very common in Japanese. They are formed by taking a Hiragana ending in "i" (like き ki, し shi, ち chi, に ni, ひ hi, み mi, り ri) and adding a small version of や (ゃ), ゆ (ゅ), or よ (ょ).'
  }, {
    id: 'd9-hiragana-yoon',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'hiragana',
...
// Day 10: Introduction to Katakana (Vowels & K, S lines)
{
  ...
  contentBlocks: [{
    id: 'd10-intro',
    type: ContentBlockType.TEXT,
    title: 'New Script: Katakana!',
    markdownContent: 'Katakana is another phonetic script like Hiragana. It has the same sounds but different, more angular characters. It\'s primarily used for foreign loanwords (e.g., テレビ terebi - TV), onomatopoeia, and for emphasis.'
  }, {
    id: 'd10-katakana-vowels',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: Vowel Sounds (ア, イ, ウ, エ, オ)',
    introduction: 'These are the Katakana vowels. Some might look similar to their Hiragana counterparts or even Kanji!',
    characters: katakanaVowels
  }, {
    id: 'd10-katakana-k',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: K-line (カ, キ, ク, ケ, コ)',
    introduction: 'Katakana "k" sounds. Compare カ (ka) to Hiragana か (ka).',
    characters: katakanaKLine
  }, {
    id: 'd10-katakana-s',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: S-line (サ, シ, ス, セ, ソ)',
    introduction: 'Katakana "s" sounds. Note シ (shi) and ソ (so) look very similar to ツ (tsu) and ン (n) respectively – pay attention to stroke direction and angle!',
    characters: katakanaSLine
  }, {
    id: 'd10-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Katakana Vocabulary (Loanwords)',
    items: [{
      id: 'd10-vocab-0',
      japanese: 'アメリカ',
      romaji: 'amerika',
...
// Day 11: Katakana (T, N lines) & Long Vowel Sound
{
  ...
  contentBlocks: [{
    id: 'd11-intro',
    type: ContentBlockType.TEXT,
    title: 'More Katakana & Elongated Sounds!',
    markdownContent: 'Continuing with Katakana and a simple way to show long vowels.'
  }, {
    id: 'd11-katakana-t',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: T-line (タ, チ, ツ, テ, ト)',
    introduction: 'Katakana "t" sounds. Watch out for ツ (tsu) – it\'s very similar to シ (shi) and ソ (so)! Angle is key.',
    characters: katakanaTLine
  }, {
    id: 'd11-katakana-n',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: N-line (ナ, ニ, ヌ, ネ, ノ)',
    introduction: 'Katakana "n" sounds. ニ (ni) is simple. ノ (no) is just one stroke.',
    characters: katakanaNLine
  }, {
    id: 'd11-grammar-long-vowel',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Long Vowel Sound in Katakana (ー)',
...
// Day 12: Katakana (H, M lines) & Small Tsu (ッ)
{
  ...
  contentBlocks: [{
    id: 'd12-intro',
    type: ContentBlockType.TEXT,
    title: 'Katakana Continues: H, M & Double Consonants!',
    markdownContent: 'More Katakana and an important symbol for pronunciation!'
  }, {
    id: 'd12-katakana-h',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: H-line (ハ, ヒ, フ, ヘ, ホ)',
    introduction: 'Katakana "h" sounds.',
    characters: katakanaHLine
  }, {
    id: 'd12-katakana-m',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: M-line (マ, ミ, ム, メ, モ)',
    introduction: 'Katakana "m" sounds.',
    characters: katakanaMLine
  }, {
    id: 'd12-grammar-small-tsu',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Small Tsu (ッ) - Sokuon (促音)',
...
// Day 13: Katakana (Y, R, W lines, ン)
{
  ...
  contentBlocks: [{
    id: 'd13-intro',
    type: ContentBlockType.TEXT,
    title: 'Finishing Basic Katakana!',
    markdownContent: 'Almost there! Today we cover the remaining standard Katakana characters.'
  }, {
    id: 'd13-katakana-y',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: Y-line (ヤ, ユ, ヨ)',
    introduction: 'Katakana "y" sounds.',
    characters: katakanaYLine
  }, {
    id: 'd13-katakana-r',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: R-line (ラ, リ, ル, レ, ロ)',
    introduction: 'Katakana "r" sounds. リ (ri) is similar to Hiragana り.',
    characters: katakanaRLine
  }, {
    id: 'd13-katakana-w-n',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: W-line (ワ, ヰ, ヱ, ヲ) and ン (N)',
...
// Day 14: Katakana Dakuten, Handakuten & Yōon
{
  ...
  contentBlocks: [{
    id: 'd14-intro',
    type: ContentBlockType.TEXT,
    title: 'Expanding Katakana Sounds!',
    markdownContent: 'Just like Hiragana, Katakana uses dakuten, handakuten, and small ヤ, ユ, ヨ to create more sounds.'
  }, {
    id: 'd14-katakana-dakuten',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    ...
    id: 'd14-katakana-yoon',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Katakana: Yōon (Combined Sounds)',
    ...
    id: 'd14-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary with Katakana Variations',
    items: [{
      id: 'd14-vocab-0',
      japanese: 'ジャズ',
      romaji: 'jazu',
...
// Day 15: Review Hiragana & Katakana
{
  ...
  contentBlocks: [{
    id: 'd15-intro',
    type: ContentBlockType.TEXT,
    title: 'Mastering the Kana!',
    markdownContent: 'You\'ve learned all the basic Hiragana and Katakana! Today is for comprehensive review. This is a huge milestone!'
  }, {
    id: 'd15-hiragana-full-review',
    type: ContentBlockType.TEXT,
    title: 'Hiragana Review',
    markdownContent: 'Go back through Days 1-9. Practice reading and writing all Hiragana characters, including vowels, k,s,t,n,h,m,y,r,w lines, ん, dakuten, handakuten, and yōon sounds.'
  }, {
    id: 'd15-katakana-full-review',
    type: ContentBlockType.TEXT,
    title: 'Katakana Review',
    markdownContent: 'Go back through Days 10-14. Practice reading and writing all Katakana characters, including vowels, k,s,t,n,h,m,y,r,w lines, ン, long vowel mark (ー), small tsu (ッ), dakuten, handakuten, and yōon sounds.'
  }, {
    id: 'd15-culture-note',
    type: ContentBlockType.CULTURAL_NOTE,
    title: 'Karaoke (カラオケ)',
    note: 'Karaoke is a hugely popular pastime in Japan, originating there! Many song lyrics will use a mix of Hiragana, Katakana, and Kanji. Being able to read Kana is your first step to singing along!'
  }
...
// Day 16: Demonstratives (これ, それ, あれ, この, その, あの)
{
  ...
  contentBlocks: [{
    ...
    exampleSentences: [{
      ...
      id: 'd16-gram-ex-1',
      japanese: 'それはわたしのかさです。',
      romaji: 'Sore wa watashi no kasa desu.',
      meaning: 'That is my umbrella.'
    }, {
      id: 'd16-gram-ex-2',
      japanese: 'あれはなんですか。',
      romaji: 'Are wa nan desu ka?',
      meaning: 'What is that over there? (なん nan = what)'
    }]
  }, {
    id: 'd16-intro-kono',
    type: ContentBlockType.TEXT,
    title: 'この, その, あの - This and That (Adjectives/Determiners)',
    markdownContent: 'These words must be followed by a noun. They describe *which* specific item you are talking about.\n- **この (kono) + Noun**: This [Noun] (near the speaker).\n- **その (sono) + Noun**: That [Noun] (near the listener).\n- **あの (ano) + Noun**: That [Noun] over there (far from both).'
  }, {
    id: 'd16-grammar-kono',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Using この, その, あの',
    ...
    exampleSentences: [{
      id: 'd16-gram-ex-3',
      japanese: 'このペンはあなたのですか。',
      romaji: 'Kono pen wa anata no desu ka?',
      meaning: 'Is this pen yours?'
    }, {
      id: 'd16-gram-ex-4',
      japanese: 'そのかばんはかわいいですね。',
      romaji: 'Sono kaban wa kawaii desu ne.',
      meaning: 'That bag is cute, isn\'t it? (ね ne - sentence ending particle seeking agreement)'
    }, {
      id: 'd16-gram-ex-5',
      japanese: 'あのひとはだれですか。',
      romaji: 'Ano hito wa dare desu ka?',
      meaning: 'Who is that person over there? (だれ dare = who)'
    }]
  }, {
    id: 'd16-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
...
// Day 17: Basic Adjectives (い-adjectives & な-adjectives)
{
  ...
  contentBlocks: [{
    id: 'd17-intro',
    type: ContentBlockType.TEXT,
    title: 'Adding Color: Adjectives!',
    markdownContent: 'Adjectives are words that describe nouns. Japanese has two main types: い-adjectives and な-adjectives.'
  }, {
    id: 'd17-grammar-i-adj',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'い-Adjectives',
    ...
    exampleSentences: [{
      ...
      id: 'd17-i-adj-ex-1',
      japanese: 'そのねこはちいさいです。',
      romaji: 'Sono neko wa chiisai desu.',
      meaning: 'That cat is small.'
    }, {
      id: 'd17-i-adj-ex-2',
      japanese: 'おいしいすしですね。',
      romaji: 'Oishii sushi desu ne.',
      meaning: 'It\'s delicious sushi, isn\'t it?'
    }]
  }, {
    id: 'd17-grammar-na-adj',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'な-Adjectives',
    ...
    exampleSentences: [{
      ...
      id: 'd17-na-adj-ex-1',
      japanese: 'あのひとはしんせつです。',
      romaji: 'Ano hito wa shinsetsu desu.',
      meaning: 'That person (over there) is kind.'
    }, {
      id: 'd17-na-adj-ex-2',
      japanese: 'このまちはにぎやかですか。',
      romaji: 'Kono machi wa nigiyaka desu ka?',
      meaning: 'Is this town lively?'
    }]
  }, {
    id: 'd17-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    ...
    items: [{
      ...
      japanese: 'ふるい',
      romaji: 'furui',
      meaning: 'old (for things, い-adj)'
    }, {
      id: 'd17-vocab-4',
      japanese: 'おいしい',
      romaji: 'oishii',
      meaning: 'delicious (い-adj)'
    }, {
      id: 'd17-vocab-5',
      japanese: 'しずか（な）',
      romaji: 'shizuka (na)',
...
// Day 18: Telling Time
{
  ...
  contentBlocks: [{
    id: 'd18-intro',
    type: ContentBlockType.TEXT,
    title: 'Let\'s Learn to Tell Time!',
    markdownContent: 'Knowing how to tell time is essential for daily conversations and making plans.'
  }, {
    id: 'd18-kanji-ji',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji for Time: 時 (ji)',
    introduction: 'This Kanji means "time" or "hour". You\'ll see it often!',
    characters: kanji_Toki_Time
  }, {
    id: 'd18-vocab-timeunits',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Basic Time Vocabulary',
    items: [{
      id: 'd18-vocab-0',
      japanese: 'いま',
      romaji: 'ima',
      ...
      japanese: '～じ',
      romaji: '-ji',
      meaning: 'o\'clock (hour marker)'
    }, {
      id: 'd18-vocab-3',
      japanese: '～ふん / ～ぷん',
      romaji: '-fun / -pun',
      meaning: 'minute marker'
    }, {
      id: 'd18-vocab-4',
      japanese: 'ごぜん',
      romaji: 'gozen',
      ...
      japanese: 'ごご',
      romaji: 'gogo',
      meaning: 'P.M. (afternoon/evening)'
    }, {
      id: 'd18-vocab-6',
      japanese: 'はん',
      romaji: 'han',
      meaning: 'half (as in half past)'
    }]
  }, {
    id: 'd18-grammar-hours',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Hours (～時 -ji)',
    ...
    id: 'd18-grammar-minutes',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Minutes (～分 -fun/pun)',
    ...
    exampleSentences: [{
      ...
      japanese: 'じゅっぷん',
      romaji: 'jup-pun',
      meaning: '10 minutes (note the sound change for 10)'
    }, {
      id: 'd18-min-ex-2',
      japanese: 'じゅうごふん',
      romaji: 'juu-go-fun',
    ...
    exampleSentences: [{
      ...
      id: 'd18-ask-ex-1',
      japanese: 'ごぜん くじ じゅっぷん です。',
      romaji: 'Gozen ku-ji jup-pun desu.',
      meaning: 'It is 9:10 A.M.'
    }, {
      id: 'd18-ask-ex-2',
      japanese: 'ごご にじ はん です。',
      romaji: 'Gogo ni-ji han desu.',
      meaning: 'It is 2:30 P.M.'
    }]
  }
...
// Day 19: Days of the Week & Months
{
  ...
  contentBlocks: [{
    id: 'd19-intro',
    type: ContentBlockType.TEXT,
    title: 'Marking Your Calendar!',
    markdownContent: 'Let\'s learn how to talk about days and months. You\'ll see familiar Kanji here!'
  }, {
    id: 'd19-kanji-review',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Relevant Kanji Review',
    introduction: 'Remember these Kanji? They are key to understanding days of the week and months!',
    characters: [getCharOrThrow(kanjiSet1_NumbersPeopleDay, '日', "Day 19 Kanji Review '日'"), getCharOrThrow(kanjiSet2_ElementsTime, '月', "Day 19 Kanji Review '月'"), getCharOrThrow(kanjiSet2_ElementsTime, '火', "Day 19 Kanji Review '火'"), getCharOrThrow(kanjiSet2_ElementsTime, '水', "Day 19 Kanji Review '水'"), getCharOrThrow(kanjiSet2_ElementsTime, '木', "Day 19 Kanji Review '木'"), getCharOrThrow(kanjiSet2_ElementsTime, '金', "Day 19 Kanji Review '金'"), getCharOrThrow(kanjiSet2_ElementsTime, '土', "Day 19 Kanji Review '土'")].filter(Boolean)
  }, {
    id: 'd19-vocab-daysweek',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Days of the Week (ようび - yōbi)',
    items: [{
      id: 'd19-vocab-0',
      japanese: 'げつようび (月曜日)',
      romaji: 'getsuyōbi',
    ...
    id: 'd19-vocab-months',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Months of the Year (がつ - gatsu)',
    items: [{
      id: 'd19-vocab-m1',
      japanese: 'いちがつ (一月)',
      romaji: 'ichigatsu',
      ...
      japanese: 'くがつ (九月)',
      romaji: 'kugatsu',
      meaning: 'September (note: く not きゅう)'
    }, {
      id: 'd19-vocab-m10',
      japanese: 'じゅうがつ (十月)',
      romaji: 'jūgatsu',
    ...
    id: 'd19-vocab-othercal',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Other Calendar Words',
    items: [{
      id: 'd19-vocab-c1',
      japanese: 'きょう (今日)',
      romaji: 'kyō',
...
// Day 20: Past Tense (Noun/Adj でした, Verb ました/ませんでした)
{
  ...
  contentBlocks: [{
    ...
    markdownContent: 'Let\'s learn how to express things that have already happened using the past tense.'
  }, {
    id: 'd20-grammar-past-noun-na',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Past Tense: Nouns & な-Adjectives',
    ...
    exampleSentences: [{
      ...
      id: 'd20-past-ex-1',
      japanese: 'あのえいがはきれいでした。',
      romaji: 'Ano eiga wa kirei deshita.',
      meaning: 'That movie was beautiful. (えいが eiga - movie)'
    }, {
      id: 'd20-past-ex-2',
      japanese: 'かれはがくせいではありませんでした。',
      romaji: 'Kare wa gakusei dewa arimasen deshita.',
      meaning: 'He was not a student. (かれ kare - he)'
    }]
  }, {
    id: 'd20-grammar-past-verb',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Past Tense: Verbs (ます-form)',
    ...
    exampleSentences: [{
      id: 'd20-verb-ex-0',
      japanese: 'きのう すしをたべました。',
      romaji: 'Kinō sushi o tabemashita.',
      meaning: 'I ate sushi yesterday. (を o - object marker)'
    }, {
      id: 'd20-verb-ex-1',
      japanese: 'わたしはきのう がっこうへいきました。',
      romaji: 'Watashi wa kinō gakkō e ikimashita.',
      meaning: 'I went to school yesterday. (がっこう gakkō - school; へ e - to/towards; いきます ikimasu - to go)'
    }, {
      id: 'd20-verb-ex-2',
      japanese: 'かれはコーヒーをのみませんでした。',
      romaji: 'Kare wa koohii o nomimasen deshita.',
      meaning: 'He did not drink coffee. (のみます nomimasu - to drink)'
    }]
  }, {
    id: 'd20-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Related Verbs (Dictionary form / ます-form)',
    items: [{
      id: 'd20-vocab-0',
      japanese: 'たべる / たべます',
...
// Day 21: Intro to Kanji & Basic Characters
{
  ...
  contentBlocks: [{
    ...
    id: 'd21-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary with New Kanji',
    items: [{
      id: 'd21-vocab-0',
      japanese: 'いち (一)',
      romaji: 'ichi',
...
// Day 22: More Basic Kanji (Elements & Time)
{
  ...
  contentBlocks: [{
    id: 'd22-intro',
    type: ContentBlockType.TEXT,
    title: 'Kanji for Elements and Time',
    markdownContent: 'Many of these Kanji are fundamental building blocks for vocabulary related to nature, time, and the calendar.'
  }, {
    id: 'd22-kanji-set2',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Set 2: Elements & Year',
    ...
    items: [{
      ...
      japanese: 'ことし (今年)',
      romaji: 'kotoshi',
      meaning: 'this year (今 - now, 年 - year)'
    }, {
      id: 'd22-vocab-7',
      japanese: 'らいねん (来年)',
      romaji: 'rainen',
      meaning: 'next year (来 - come, 年 - year)'
    }]
  }, {
...
// Day 23: Particles で (Location of Action/Means) & と (And/With)
{
  ...
  contentBlocks: [{
    id: 'd23-intro',
    type: ContentBlockType.TEXT,
    title: 'More Useful Particles: で and と',
    markdownContent: 'These particles add significant detail to your sentences, allowing you to specify locations, tools, and connections.'
  }, {
    id: 'd23-grammar-de',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Particle で (de): Location of Action / Means',
    ...
    exampleSentences: [{
      id: 'd23-de-ex-0',
      japanese: 'がっこうでべんきょうします。',
      romaji: 'Gakkō de benkyō shimasu.',
      meaning: 'I study at school. (べんきょうします benkyō shimasu - to study)'
    }, {
      id: 'd23-de-ex-1',
      japanese: 'バスでかいしゃへいきます。',
      romaji: 'Basu de kaisha e ikimasu.',
      meaning: 'I go to the company by bus. (バス basu - bus)'
    }, {
      id: 'd23-de-ex-2',
      japanese: 'はしでごはんをたべますか。',
      romaji: 'Hashi de gohan o tabemasu ka?',
      meaning: 'Do you eat rice with chopsticks? (はし hashi - chopsticks, ごはん gohan - rice/meal)'
    }]
  }, {
    id: 'd23-grammar-to',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Particle と (to): And / With',
    ...
    exampleSentences: [{
      id: 'd23-to-ex-0',
      japanese: 'わたしはいぬとねこがすきです。',
      romaji: 'Watashi wa inu to neko ga suki desu.',
      meaning: 'I like dogs and cats. (すき suki - like, が ga - subject marker for likes/dislikes)'
    }, {
      id: 'd23-to-ex-1',
      japanese: 'せんせいとはなしました。',
      romaji: 'Sensei to hanashimashita.',
      meaning: 'I talked with the teacher. (はなします hanashimasu - to talk)'
    }, {
      id: 'd23-to-ex-2',
      japanese: 'コーヒーとケーキをください。',
      romaji: 'Koohii to keeki o kudasai.',
      meaning: 'Coffee and cake, please. (ください kudasai - please give me)'
    }]
  }, {
    id: 'd23-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
...
// Day 24: More Kanji & Reading Practice
{
  ...
  contentBlocks: [{
    id: 'd24-intro',
    type: ContentBlockType.TEXT,
    title: 'Descriptive Kanji & Reading Time!',
    markdownContent: 'Let\'s learn Kanji that help describe things and then try to read a short passage putting it all together!'
  }, {
    id: 'd24-kanji-set3',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Set 3: Sizes & Position',
    ...
    items: [{
      ...
      japanese: 'だいがく (大学)',
      romaji: 'daigaku',
      meaning: 'university (big learn)'
    }, {
      id: 'd24-vocab-1',
      japanese: 'しょうがっこう (小学校)',
      romaji: 'shōgakkō',
      meaning: 'elementary school (small learn school)'
    }, {
      id: 'd24-vocab-2',
      japanese: 'ちゅうごく (中国)',
      romaji: 'Chūgoku',
      meaning: 'China (middle country)'
    }, {
      id: 'd24-vocab-3',
      japanese: 'うえ (上)',
      romaji: 'ue',
...
// Day 25: Particle に (Time, Location, Destination) & More Kanji
{
  ...
  contentBlocks: [{
    id: 'd25-intro',
    type: ContentBlockType.TEXT,
    title: 'Mastering Particle に (ni)',
    markdownContent: 'The particle に (ni) is incredibly versatile! Today we will explore its main uses for indicating time, where things exist, and where you are going.'
  }, {
    id: 'd25-grammar-ni',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Particle に (ni): Key Uses',
    ...
    exampleSentences: [{
      ...
      meaning: 'I wake up at 6:30.'
    }, {
      id: 'd25-ni-ex-1',
      japanese: 'つくえのしたにいぬがいます。',
      romaji: 'Tsukue no shita ni inu ga imasu.',
      meaning: 'There is a dog under the desk.'
    }, {
      id: 'd25-ni-ex-2',
      japanese: 'あした きょうとへ/にいきます。',
      romaji: 'Ashita Kyōto e/ni ikimasu.',
      meaning: 'I will go to Kyoto tomorrow.'
    }, {
      id: 'd25-ni-ex-3',
      japanese: 'ははにてがみをかきました。',
      romaji: 'Haha ni tegami o kakimashita.',
      meaning: 'I wrote a letter to my mother. (はは haha - mother, てがみ tegami - letter, かきました kakimashita - wrote)'
    }]
  }, {
    id: 'd25-kanji-set4',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Set 4: Directions & Places',
    ...
    id: 'd25-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary for Particle に',
    items: [{
      id: 'd25-vocab-0',
      japanese: 'きます (来ます)',
      romaji: 'kimasu',
      ...
      japanese: 'かえります (帰ります)',
      romaji: 'kaerimasu',
      meaning: 'to return (home, to one\'s origin)'
    }, {
      id: 'd25-vocab-2',
      japanese: 'おきます (起きます)',
      romaji: 'okimasu',
      ...
      japanese: 'あります',
      romaji: 'arimasu',
      meaning: 'to exist, to be (inanimate things), to have'
    }, {
      id: 'd25-vocab-4',
      japanese: 'います',
      romaji: 'imasu',
      meaning: 'to exist, to be (animate things)'
    }, {
      id: 'd25-vocab-5',
      japanese: 'うち',
      romaji: 'uchi',
...
// Day 26: Particles へ (Direction) & を (Object Marker)
{
  ...
  contentBlocks: [{
    id: 'd26-intro',
    type: ContentBlockType.TEXT,
    title: 'Specifying Direction and Objects',
    markdownContent: 'Today we explore two more crucial particles: へ (e) for direction and を (o) to show what is being acted upon.'
  }, {
    id: 'd26-grammar-e',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Particle へ (e): Direction',
    ...
    exampleSentences: [{
      ...
      id: 'd26-e-ex-1',
      japanese: 'スーパーへかいものにいきました。',
      romaji: 'Sūpā e kaimono ni ikimashita.',
      meaning: 'I went to the supermarket for shopping. (スーパー sūpā - supermarket, かいもの kaimono - shopping, に here shows purpose)'
    }]
  }, {
    id: 'd26-grammar-o',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Particle を (o): Direct Object Marker',
    ...
    exampleSentences: [{
      ...
      meaning: 'What will you do? (します shimasu - to do)'
    }]
  }, {
    id: 'd26-kanji-set5',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Set 5: Verbs & Actions',
    ...
    id: 'd26-vocab',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Vocabulary for Particles へ & を',
    items: [{
      id: 'd26-vocab-0',
      japanese: 'しんぶん (新聞)',
      romaji: 'shinbun',
...
// Day 27: い-Adjectives (Past & Negative Conjugation)
{
  ...
  contentBlocks: [{
    id: 'd27-intro',
    type: ContentBlockType.TEXT,
    title: 'Describing in More Detail: Adjective Conjugation',
    markdownContent: 'Today, we learn how to change い-adjectives to talk about past states or negate them. This greatly expands your descriptive power!'
  }, {
    id: 'd27-grammar-i-adj-conj',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'い-Adjective Conjugation (Polite Form)',
    ...
    exampleSentences: [{
      id: 'd27-iconj-ex-0',
      japanese: 'きのうのテストはむずかしかったです。',
      romaji: 'Kinō no tesuto wa muzukashikatta desu.',
      meaning: 'Yesterday\'s test was difficult. (テスト tesuto - test, むずかしい muzukashii - difficult)'
    }, {
      id: 'd27-iconj-ex-1',
      japanese: 'このりんごはおいしくないです。',
      romaji: 'Kono ringo wa oishikunai desu.',
      meaning: 'This apple is not delicious. (りんご ringo - apple)'
    }, {
      id: 'd27-iconj-ex-2',
      japanese: 'せんしゅうのてんきはよくなかったです。',
      romaji: 'Senshū no tenki wa yoku nakatta desu.',
      meaning: 'Last week\'s weather was not good. (てんき tenki - weather)'
    }, {
      id: 'd27-iconj-ex-3',
      japanese: 'そのえいがはとてもおもしかったです。',
      romaji: 'Sono eiga wa totemo omoshirokatta desu.',
      meaning: 'That movie was very interesting. (おもしろい omoshiroi - interesting)'
    }]
  }, {
    id: 'd27-kanji-set6',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Set 6: Descriptive Adjectives',
    ...
    items: [{
      ...
      japanese: 'あつい (暑い/熱い)',
      romaji: 'atsui',
      meaning: 'hot (weather/object)'
    }, {
      id: 'd27-vocab-4',
      japanese: 'やさしい (易しい/優しい)',
      romaji: 'yasashii',
      meaning: 'easy / kind'
    }, {
      id: 'd27-vocab-5',
...
// Day 28: Combining Sentences (～て form introduction - for listing actions)
{
  ...
  contentBlocks: [{
    id: 'd28-intro',
    type: ContentBlockType.TEXT,
    title: 'The Versatile Te-Form: Linking Actions',
    markdownContent: 'The て-form of verbs is one of the most useful and common conjugations in Japanese. It allows you to connect multiple actions or states in a sequence, among many other uses. Today, we\'ll focus on using it to list actions one after another.'
  }, {
    id: 'd28-grammar-what-is-te',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'What is the Te-Form?',
    ...
    id: 'd28-grammar-te-conjugation',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Basic Te-Form Conjugation Rules',
    ...
    exampleSentences: [{
      id: 'd28-te-ex-g2',
      japanese: '寝る (neru - to sleep) -> 寝て (nete)',
      romaji: '',
      meaning: ''
    }, {
      id: 'd28-te-ex-g1u',
      japanese: '歌う (utau - to sing) -> 歌って (utatte)',
      romaji: '',
      meaning: ''
    }, {
      id: 'd28-te-ex-g1mu',
      japanese: '読む (yomu - to read) -> 読んで (yonde)',
      romaji: '',
      meaning: ''
    }, {
      id: 'd28-te-ex-g1ku',
      japanese: '聞く (kiku - to listen) -> 聞いて (kiite)',
      romaji: '',
      meaning: ''
    }]
  }, {
    id: 'd28-grammar-te-sequential',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Using Te-Form for Sequential Actions',
    ...
    exampleSentences: [{
      id: 'd28-seq-ex-0',
      japanese: '朝起きて、顔を洗って、朝ご飯を食べました。',
      romaji: 'Asa okite, kao o aratte, asagohan o tabemashita.',
      meaning: 'In the morning, I woke up, washed my face, and ate breakfast. (顔 kao - face, 洗う arau - to wash)'
    }, {
      id: 'd28-seq-ex-1',
      japanese: 'うちに帰って、宿題をして、寝ます。',
      romaji: 'Uchi ni kaette, shukudai o shite, nemasu.',
      meaning: 'I will return home, do my homework, and sleep. (宿題 shukudai - homework, 寝ます nemasu - to sleep)'
    }]
  }, {
    id: 'd28-kanji-set-iku',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Spotlight: 行 (to go)',
    introduction: 'The Kanji 行 is very common and means "to go", "journey", or "carry out". Its te-form is an exception: 行って (itte).',
    characters: [getCharOrThrow(kanjiSet7_ActionsMisc, '行', "Day 28 Kanji Spotlight '行'")].filter(Boolean)
  }, {
    id: 'd28-vocab-verbs',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Common Verbs for Te-Form Practice',
    items: [{
      id: 'd28-vocab-0',
      japanese: 'おきる (起きます)',
      romaji: 'okiru (okimasu)',
      meaning: 'to wake up, get up (Group 2)'
    }, {
      id: 'd28-vocab-1',
      japanese: 'ねる (寝ます)',
      romaji: 'neru (nemasu)',
      meaning: 'to sleep, go to bed (Group 2)'
    }, {
      id: 'd28-vocab-2',
      japanese: 'あらう (洗います)',
      romaji: 'arau (araimasu)',
      meaning: 'to wash (Group 1, -u)'
    }, {
      id: 'd28-vocab-3',
      japanese: 'まつ (持ちます)',
      romaji: 'matsu (mochimasu)',
      meaning: 'to wait (Group 1, -tsu)'
    }, {
      id: 'd28-vocab-4',
      japanese: 'つくる (作ります)',
      romaji: 'tsukuru (tsukurimasu)',
      meaning: 'to make, create (Group 1, -ru)'
    }, {
      id: 'd28-vocab-5',
      japanese: 'あそぶ (遊びます)',
      romaji: 'asobu (asobimasu)',
      meaning: 'to play, hang out (Group 1, -bu)'
    }, {
      id: 'd28-vocab-6',
      japanese: 'いそぐ (急ぎます)',
      romaji: 'isogu (isogimasu)',
      meaning: 'to hurry (Group 1, -gu)'
    }]
  }, {
...
// Day 29: Expressing "Want" (～たいです) & Hobby
{
  ...
  contentBlocks: [{
    id: 'd29-intro',
    type: ContentBlockType.TEXT,
    title: 'Expressing Desires and Interests',
    markdownContent: 'Today, you\'ll learn how to say "I want to do..." and how to talk about your hobbies. This will make your conversations much more personal!'
  }, {
    id: 'd29-grammar-tai-desu',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Expressing "Want to do": ～たいです (-tai desu)',
    ...
    exampleSentences: [{
      id: 'd29-tai-ex-0',
      japanese: 'わたしはにほんへいきたいです。',
      romaji: 'Watashi wa Nihon e ikitai desu.',
      meaning: 'I want to go to Japan.'
    }, {
      id: 'd29-tai-ex-1',
      japanese: 'あたらしいカメラが/をかいたいです。',
      romaji: 'Atarashii kamera ga/o kaitai desu.',
      meaning: 'I want to buy a new camera.'
    }, {
      id: 'd29-tai-ex-2',
      japanese: 'きのうはえいがをみたかったです。',
      romaji: 'Kinō wa eiga o mitakatta desu.',
      meaning: 'I wanted to watch a movie yesterday.'
    }, {
      id: 'd29-tai-ex-3',
      japanese: 'なにもたべたくないです。',
      romaji: 'Nani mo tabetakunai desu.',
      meaning: 'I don\'t want to eat anything. (なにも nani mo - anything/nothing with negative)'
    }]
  }, {
    id: 'd29-grammar-shumi',
    type: ContentBlockType.GRAMMAR_EXPLANATION,
    title: 'Talking About Hobbies (しゅみ - shumi)',
    ...
    exampleSentences: [{
      id: 'd29-shumi-ex-0',
      japanese: 'あなたのしゅみはなんですか。',
      romaji: 'Anata no shumi wa nan desu ka?',
      meaning: 'What is your hobby?'
    }, {
      id: 'd29-shumi-ex-1',
      japanese: 'わたしのしゅみはどくしょです。',
      romaji: 'Watashi no shumi wa dokusho desu.',
      meaning: 'My hobby is reading books. (どくしょ dokusho - reading)'
    }, {
      id: 'd29-shumi-ex-2',
      japanese: 'わたしのしゅみはおんがくをきくことです。',
      romaji: 'Watashi no shumi wa ongaku o kiku koto desu.',
      meaning: 'My hobby is listening to music.'
    }]
  }, {
    id: 'd29-kanji-set-actions',
    type: ContentBlockType.KANA_INFO,
    kanaSet: 'katakana',
    title: 'Kanji Spotlight: Likes & Actions',
    introduction: 'These Kanji relate to desires and common hobby actions.',
    characters: [getCharOrThrow(kanjiSet7_ActionsMisc, '買', "Day 29 Kanji Spotlight '買'"), getCharOrThrow(kanjiSet7_ActionsMisc, '旅', "Day 29 Kanji Spotlight '旅'"), getCharOrThrow(kanjiSet7_ActionsMisc, '好', "Day 29 Kanji Spotlight '好'")].filter(Boolean)
  }, {
    id: 'd29-vocab-hobbies',
    type: ContentBlockType.VOCABULARY_LIST,
    title: 'Hobbies & Related Verbs',
    items: [{
      id: 'd29-vocab-0',
      japanese: 'しゅみ (趣味)',
      romaji: 'shumi',
      ...
      id: 'd29-vocab-1',
      japanese: 'スポーツをすること',
      romaji: 'supootsu o suru koto',
      meaning: 'playing sports'
    }, {
      id: 'd29-vocab-2',
      japanese: 'りょこう (旅行)',
      romaji: 'ryokou',
      ...
      id: 'd29-vocab-4',
      japanese: 'ゲームをすること',
      romaji: 'geemu o suru koto',
      meaning: 'playing games'
    }, {
      id: 'd29-vocab-5',
      japanese: 'えをかくこと (絵を描くこと)',
      romaji: 'e o kaku koto',
      meaning: 'drawing pictures (絵 e - picture)'
    }, {
      id: 'd29-vocab-6',
      japanese: 'うたう (歌います)',
      romaji: 'utau (utaimasu)',
      meaning: 'to sing'
    }, {
      id: 'd29-vocab-7',
      japanese: 'およぐ (泳ぎます)',
      romaji: 'oyogu (oyogimasu)',
      meaning: 'to swim'
    }]
  }, {
...
export const thirtyDayPlan = thirtyDayPlan_Unprocessed.map(lessonDay => {
  ...
  if (culturalNoteIndex !== -1) {
    ...
    const learningBlockTypes = [ContentBlockType.KANA_INFO, ContentBlockType.VOCABULARY_LIST, ContentBlockType.GRAMMAR_EXPLANATION, ContentBlockType.FILL_IN_THE_BLANK_EXERCISE, ContentBlockType.WRITING_PRACTICE, ContentBlockType.TEXT];
